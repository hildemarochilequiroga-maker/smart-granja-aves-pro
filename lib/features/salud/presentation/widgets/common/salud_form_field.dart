/// Campo de formulario personalizado para el módulo de salud
/// Diseño consistente con GranjaFormField - Estilo Wialon
library;
...
/// Campo de formulario personalizado para salud
/// Estilo Wialon - Label encima, bordes sutiles
class SaludFormField extends StatefulWidget {
  const SaludFormField({
    super.key,
    this.controller,
    required this.label,
    this.hint,
  ...
  @override
  State<SaludFormField> createState() => _SaludFormFieldState();
}

class _SaludFormFieldState extends State<SaludFormField> {
  ...
  String? _validarRequerido(String? valor) {
    if (valor == null || valor.trim().isEmpty) {
      return S.of(context).commonFieldRequired;
    }
    return null;
  }
}
