...
abstract class GalponDialogs {
  ...
  static Future<EstadoGalpon?> showCambiarEstadoDialog(
    ...
    return showModalBottomSheet<EstadoGalpon>(
      context: context,
...
class _CambiarEstadoDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AppBottomSheetScaffold(
      title: S.of(context).shedChangeStatus,
      scrollable: true,
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          Flexible(
            child: ListView(
              ...
              children: [
                ...
                // Card estado actual
                AppSheetOptionTile(
                  leading: _buildColorDot(galpon.estado.color, size: 14),
                  label: galpon.estado.localizedDisplayName(S.of(context)),
                  subtitle: _getDescripcionEstado(context, galpon.estado),
