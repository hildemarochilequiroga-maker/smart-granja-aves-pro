...
/// Diseño consistente con el feature de granjas (estilo Wialon)
library;
...
/// Campo de formulario personalizado para galpones
/// Sigue el patrón de diseño de GranjaFormField con label arriba del campo
class GalponFormField extends StatefulWidget {
  ...
  @override
  State<GalponFormField> createState() => _GalponFormFieldState();
}

class _GalponFormFieldState extends State<GalponFormField> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        // Label arriba del campo (estilo Wialon)
        Text(
          labelText,
