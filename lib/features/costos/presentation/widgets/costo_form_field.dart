/// Campo de formulario personalizado para los costos
...
class CostoFormField extends StatefulWidget {
  const CostoFormField({
    super.key,
    this.controller,
    required this.label,
    this.hint,
  ...
  @override
  State<CostoFormField> createState() => _CostoFormFieldState();
}

class _CostoFormFieldState extends State<CostoFormField> {
