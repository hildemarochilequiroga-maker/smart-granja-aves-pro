...
class RegistroProduccionFirebaseDatasource {
  ...
  /// Crea un registro de producción y actualiza campos del lote
  /// (huevosProducidos, fechaPrimerHuevo, etc.) en una transacción atómica.
  ///
  /// Garantiza que ambas escrituras se apliquen o ninguna, evitando
  /// inconsistencia entre el subdocumento y el agregado del lote.
  Future<RegistroProduccion> crearConActualizacionLote({
    required RegistroProduccion registro,
