/// Campo de formulario personalizado para los lotes
...
class LoteFormField extends StatefulWidget {
  const LoteFormField({
    super.key,
    this.controller,
    required this.label,
  ...
  @override
  State<LoteFormField> createState() => _LoteFormFieldState();
}

class _LoteFormFieldState extends State<LoteFormField> {
