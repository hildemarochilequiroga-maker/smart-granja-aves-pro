  ...
  static const _messages = <String, Map<String, String>>{
    'es': {
      ...
      'ALERT_BIENVENIDO_MSG':
          'Gracias por usar Smart Granja Aves. Explora las funciones disponibles.',
      'NOTIF_FALLBACK_TITLE': 'Notificación',
      'NOTIF_CHANNEL_DESC': 'Notificaciones de Smart Granja Aves',
      'ALERT_BAJO': 'bajo',
      'ALERT_ALTO': 'alto',
      'ALERT_BAJA': 'baja',
      'ALERT_ALTA': 'alta',
      ...
      // PDF - Reportes especializados (mortalidad, consumo, peso, etc.)
      'PDF_TITLE_MORTALITY': 'Reporte de Mortalidad - {farm}',
      'PDF_HEADER_MORTALITY': 'Reporte de Mortalidad y Supervivencia',
      'PDF_MORTALITY_SUMMARY': 'Resumen de Mortalidad',
      'PDF_MORTALITY_AVG': 'Mortalidad Promedio',
      'PDF_SURVIVAL': 'Supervivencia',
      'PDF_TOTAL_DEATHS': 'Total Muertes',
      'PDF_TITLE_CONSUMPTION': 'Reporte de Consumo - {farm}',
      'PDF_HEADER_CONSUMPTION': 'Reporte de Consumo de Alimento',
      'PDF_CONSUMPTION_SUMMARY': 'Resumen de Consumo',
      'PDF_CONSUMPTION_TOTAL': 'Consumo Total',
      'PDF_CONSUMPTION_AVG': 'Consumo Promedio',
      'PDF_TITLE_WEIGHT': 'Reporte de Peso - {farm}',
      'PDF_HEADER_WEIGHT': 'Reporte de Peso y Crecimiento',
      'PDF_WEIGHT_SUMMARY': 'Resumen de Peso',
      'PDF_WEIGHT_AVG_CURRENT': 'Peso Promedio Actual',
      'PDF_WEIGHT_AVG_TARGET': 'Peso Objetivo Promedio',
      'PDF_TITLE_PROFITABILITY': 'Reporte de Rentabilidad - {farm}',
      'PDF_HEADER_PROFITABILITY': 'Reporte de Rentabilidad',
      'PDF_PROFITABILITY_SUMMARY': 'Resumen de Rentabilidad',
      'PDF_TOTAL_REVENUE': 'Ingresos Totales',
      'PDF_TOTAL_COSTS_KPI': 'Costos Totales',
      'PDF_BALANCE_KPI': 'Balance',
      'PDF_PROFIT_MARGIN_KPI': 'Margen de Ganancia',
      'PDF_TITLE_HEALTH': 'Reporte de Salud - {farm}',
      'PDF_HEADER_HEALTH': 'Reporte de Salud y Tratamientos',
      'PDF_HEALTH_SUMMARY': 'Resumen de Salud',
      'PDF_HEALTHY_LOTS': 'Lotes Saludables',
      'PDF_TITLE_INVENTORY': 'Reporte de Inventario - {farm}',
      'PDF_HEADER_INVENTORY': 'Reporte de Inventario',
      'PDF_INVENTORY_SUMMARY': 'Resumen de Inventario',
      'PDF_INITIAL_QTY_TOTAL': 'Cantidad Inicial Total',
      'PDF_CURRENT_QTY_TOTAL': 'Cantidad Actual Total',
    ...
    'en': {
      ...
      'ALERT_BIENVENIDO_MSG':
          'Thank you for using Smart Granja Aves. Explore the available features.',
      'NOTIF_FALLBACK_TITLE': 'Notification',
      'NOTIF_CHANNEL_DESC': 'Smart Granja Aves notifications',
      'ALERT_BAJO': 'low',
      'ALERT_ALTO': 'high',
      'ALERT_BAJA': 'low',
      'ALERT_ALTA': 'high',
      ...
      // PDF - Specialized reports (mortality, consumption, weight, etc.)
      'PDF_TITLE_MORTALITY': 'Mortality Report - {farm}',
      'PDF_HEADER_MORTALITY': 'Mortality and Survival Report',
      'PDF_MORTALITY_SUMMARY': 'Mortality Summary',
      'PDF_MORTALITY_AVG': 'Average Mortality',
      'PDF_SURVIVAL': 'Survival',
      'PDF_TOTAL_DEATHS': 'Total Deaths',
      'PDF_TITLE_CONSUMPTION': 'Consumption Report - {farm}',
      'PDF_HEADER_CONSUMPTION': 'Feed Consumption Report',
      'PDF_CONSUMPTION_SUMMARY': 'Consumption Summary',
      'PDF_CONSUMPTION_TOTAL': 'Total Consumption',
      'PDF_CONSUMPTION_AVG': 'Average Consumption',
      'PDF_TITLE_WEIGHT': 'Weight Report - {farm}',
      'PDF_HEADER_WEIGHT': 'Weight and Growth Report',
      'PDF_WEIGHT_SUMMARY': 'Weight Summary',
      'PDF_WEIGHT_AVG_CURRENT': 'Current Average Weight',
      'PDF_WEIGHT_AVG_TARGET': 'Target Average Weight',
      'PDF_TITLE_PROFITABILITY': 'Profitability Report - {farm}',
      'PDF_HEADER_PROFITABILITY': 'Profitability Report',
      'PDF_PROFITABILITY_SUMMARY': 'Profitability Summary',
      'PDF_TOTAL_REVENUE': 'Total Revenue',
      'PDF_TOTAL_COSTS_KPI': 'Total Costs',
      'PDF_BALANCE_KPI': 'Balance',
      'PDF_PROFIT_MARGIN_KPI': 'Profit Margin',
      'PDF_TITLE_HEALTH': 'Health Report - {farm}',
      'PDF_HEADER_HEALTH': 'Health and Treatments Report',
      'PDF_HEALTH_SUMMARY': 'Health Summary',
      'PDF_HEALTHY_LOTS': 'Healthy Batches',
      'PDF_TITLE_INVENTORY': 'Inventory Report - {farm}',
      'PDF_HEADER_INVENTORY': 'Inventory Report',
      'PDF_INVENTORY_SUMMARY': 'Inventory Summary',
      'PDF_INITIAL_QTY_TOTAL': 'Total Initial Quantity',
      'PDF_CURRENT_QTY_TOTAL': 'Total Current Quantity',
    ...
    'pt': {
      ...
      'ALERT_BIENVENIDO_MSG':
          'Obrigado por usar o Smart Granja Aves. Explore as funcionalidades disponíveis.',
      'NOTIF_FALLBACK_TITLE': 'Notificação',
      'NOTIF_CHANNEL_DESC': 'Notificações do Smart Granja Aves',
      'ALERT_BAJO': 'baixo',
      'ALERT_ALTO': 'alto',
      'ALERT_BAJA': 'baixa',
      'ALERT_ALTA': 'alta',
      ...
      // PDF - Relatórios especializados (mortalidade, consumo, peso, etc.)
      'PDF_TITLE_MORTALITY': 'Relatório de Mortalidade - {farm}',
      'PDF_HEADER_MORTALITY': 'Relatório de Mortalidade e Sobrevivência',
      'PDF_MORTALITY_SUMMARY': 'Resumo de Mortalidade',
      'PDF_MORTALITY_AVG': 'Mortalidade Média',
      'PDF_SURVIVAL': 'Sobrevivência',
      'PDF_TOTAL_DEATHS': 'Total de Mortes',
      'PDF_TITLE_CONSUMPTION': 'Relatório de Consumo - {farm}',
      'PDF_HEADER_CONSUMPTION': 'Relatório de Consumo de Ração',
      'PDF_CONSUMPTION_SUMMARY': 'Resumo de Consumo',
      'PDF_CONSUMPTION_TOTAL': 'Consumo Total',
      'PDF_CONSUMPTION_AVG': 'Consumo Médio',
      'PDF_TITLE_WEIGHT': 'Relatório de Peso - {farm}',
      'PDF_HEADER_WEIGHT': 'Relatório de Peso e Crescimento',
      'PDF_WEIGHT_SUMMARY': 'Resumo de Peso',
      'PDF_WEIGHT_AVG_CURRENT': 'Peso Médio Atual',
      'PDF_WEIGHT_AVG_TARGET': 'Peso Médio Alvo',
      'PDF_TITLE_PROFITABILITY': 'Relatório de Rentabilidade - {farm}',
      'PDF_HEADER_PROFITABILITY': 'Relatório de Rentabilidade',
      'PDF_PROFITABILITY_SUMMARY': 'Resumo de Rentabilidade',
      'PDF_TOTAL_REVENUE': 'Receita Total',
      'PDF_TOTAL_COSTS_KPI': 'Custos Totais',
      'PDF_BALANCE_KPI': 'Saldo',
      'PDF_PROFIT_MARGIN_KPI': 'Margem de Lucro',
      'PDF_TITLE_HEALTH': 'Relatório de Saúde - {farm}',
      'PDF_HEADER_HEALTH': 'Relatório de Saúde e Tratamentos',
      'PDF_HEALTH_SUMMARY': 'Resumo de Saúde',
      'PDF_HEALTHY_LOTS': 'Lotes Saudáveis',
      'PDF_TITLE_INVENTORY': 'Relatório de Inventário - {farm}',
      'PDF_HEADER_INVENTORY': 'Relatório de Inventário',
      'PDF_INVENTORY_SUMMARY': 'Resumo de Inventário',
      'PDF_INITIAL_QTY_TOTAL': 'Quantidade Inicial Total',
      'PDF_CURRENT_QTY_TOTAL': 'Quantidade Atual Total',
